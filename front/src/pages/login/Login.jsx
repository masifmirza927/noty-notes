    ...
    <div id='login' className='login-page'>
      <div className='login-form p-10'>
        ...
        <form onSubmit={handleSubmit(onSubmit)} autoComplete="off">
          <div className="mb-10">
            <input type='text' {...register('username', { required: { value: true, message: "username is required" } })} className='w-full p-5 rounded-md bg-transparent border text-white' placeholder='Email address' />
          ...
          <input type='password' {...register('password')} placeholder='Password' className='w-full p-5 mb-3 rounded-md bg-transparent border text-white' />
